...
######################## se aparecer algum problema foi aqui
...
if __name__ != '__main__':
    ...
    for i in range(len(data)):
        ...
        str(data[i]).split(',')
        data = str((f'\033[;036m{data[i][0]}\033[;0m','-'*(70-len(data[i][0]))),(f'\033[;036m{data[i][1]}\033[;0m','-'*(20-len(str(data[i][1])))),(f'\033[;036m{data[i][2]}\033[;0m','-'*(10-len(str(data[i][2])))))
        GUI.janela(data)
